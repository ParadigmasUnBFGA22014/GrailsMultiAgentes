			...
			<div class="col-md-12">
				<div class="portlet box green">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-reorder"></i>Detalhar Lance
						</div>
						<div class="tools">
						...
						<g:form class="form-horizontal" role="form">
							<div class="form-body">
								...
								<div class="row">
									...
									<g:if test="${lanceInstance?.valorLance}">
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-3">Valor Lance</label>
												
											<div class="col-md-9">
												<p class="form-control-static">
													<g:fieldValue bean="${lanceInstance}" field="valorLance"/>
												</p>
											</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-offset-3 col-md-9">
											<g:hiddenField name="id" value="${lanceInstance?.id}" />

											<g:link class="btn green" action="edit" id="${lanceInstance?.id}">
