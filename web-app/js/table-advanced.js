var TableAdvanced = function () {
    ...
    var initTable4 = function() {
        ...
        jQuery('#sample_4_wrapper .dataTables_filter input').addClass("form-control input-small input-inline"); // modify table search input
    ...
    var initTable5 = function() {
        ...
        jQuery('#sample_5_wrapper .dataTables_filter input').addClass("form-control input-small input-inline"); // modify table search input
    ...
    var initTable6 = function() {
        ...
        jQuery('#sample_6_wrapper .dataTables_filter input').addClass("form-control input-small input-inline"); // modify table search input
